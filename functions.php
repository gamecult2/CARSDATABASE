...
/**
 * Send an email notification to a client and log it.
 * In a real application, this would use an email library like PHPMailer.
 */
function send_email_notification($recipient_email, $subject, $body) {
    ...
    $log_message .= "To: " . $recipient_email . "\n";
    $log_message .= "Subject: " . $subject . "\n";
    $log_message .= "Body: \n" . $body . "\n";
    $log_message .= "--------------------\n\n";

    // Log the email to a file instead of sending a real email
